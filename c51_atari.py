...
class Args:
    ...
    wandb_project_name: str = "atari_bc"
    """the wandb's project name"""
    wandb_entity: str = "matthewh6"
...
if __name__ == "__main__":
    ...
    for global_step in range(args.total_timesteps):
        logging.info(f"global step: {global_step/args.total_timesteps*100:.2f}%")
        ...
        if "final_info" in infos:
            for info in infos["final_info"]:
                if info and "episode" in info:
                    logging.info(f"global_step={global_step}, episodic_return={info['episode']['r']}")
